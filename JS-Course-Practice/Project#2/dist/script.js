...
/* harmony import */ var _modules_dragNdrop__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/dragNdrop */ "./src/js/modules/dragNdrop.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_dragNdrop__WEBPACK_IMPORTED_MODULE_12__["default"])();
});
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      resultBlock.textContent = "Your price ".concat(sum);
      resultBlock.style.fontSize = '2rem';
    }
  };
...
var dragNdrop = function dragNdrop() {
  // drag - works on the element that is dragged
  // dragend - works on the element that is dragged
  // dragenter - object on dropArea
  // dragexit - works on the element that is dragged
  // dragleave - object outside dropArea
  // dragover - the object hovers over the dropArea
  // dragstart - works on the element that is dragged
    ...
    link.addEventListener('click', function (event) {
      ...
      function step(time) {
        ...
        var progress = time - start,
            maxProgress = Math.max(widthTop - progress / speed, widthTop + toBlock),
            minProgress = Math.min(widthTop + progress / speed, widthTop + toBlock),
            r = toBlock < 0 ? maxProgress : minProgress;
